 ...
 * Displays a preview of the Quote component structure
 */
        ...
        <div className="relative px-4 py-8 md:px-8 md:py-10 lg:px-12 lg:py-12">
          <blockquote className="mx-auto max-w-4xl text-center">
            ...
            <div className="text-balance text-2xl font-medium italic leading-relaxed text-stone-800 transition-colors duration-300 group-hover/quote:text-stone-900 dark:text-white/90 dark:group-hover/quote:text-white md:text-3xl lg:text-4xl">
              &quot;This is a preview of the quote component. In design view, you can
              see the layout structure and styling that will be applied to
