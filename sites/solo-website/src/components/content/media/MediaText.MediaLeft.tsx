    ...
    <div className="flex shrink-0 flex-nowrap items-center gap-2 sm:gap-3">
      ...
      {hasSecondaryCta && (
        <Button
          variant="outline"
          size="sm"
          className="group/secondary relative overflow-hidden rounded-full border px-3 py-1.5 text-xs font-medium transition-all duration-300 hover:border-primary/50 hover:bg-primary/5 hover:shadow-sm active:scale-[0.98]"
        >
          <span className="relative z-10 flex items-center gap-1.5">
